...
export function WindowsMessageHook(cb: (
  ...
  return new Deno.UnsafeCallback(symbols.SDL_WindowsMessageHook, cb);
}
...
export function X11EventHook(cb: (
  ...
  return new Deno.UnsafeCallback(symbols.SDL_X11EventHook, cb);
}
...
export function iOSAnimationCallback(cb: (
  ...
  return new Deno.UnsafeCallback(symbols.SDL_iOSAnimationCallback, cb);
}
...
export function RequestAndroidPermissionCallback(cb: (
  ...
  return new Deno.UnsafeCallback(symbols.SDL_RequestAndroidPermissionCallback, cb);
}
