 ...
 */
export const SDL_CursorFrameInfo = new _.Struct({
  surface: _.u64, /**< SDL_Surface * : The surface data for this frame */
  duration: _.u32, /**< Uint32 : The frame duration in milliseconds (a duration of 0 is infinite) */
});
